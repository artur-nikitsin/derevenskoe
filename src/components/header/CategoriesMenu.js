            ...
            <div className={"CategoriesMenu"}>
                <Container className={"container"}>
                    <ul>
                        ...
                        <li><NavLink to="/catalog/dumplings" activeClassName='active'>Пельмени и
                            вареники</NavLink></li>
                        <li><NavLink to="/catalog/milk_products" activeClassName='active'>Молочные
                            продукты</NavLink>
                        </li>
                        ...
                        <li><NavLink to="/catalog/eggs_honey" activeClassName='active'>Яйца и мед</NavLink>
                        </li>
                        <li><NavLink to="/catalog/oils" activeClassName='active'>Растительные масла и
                            урбеч</NavLink>
                        </li>
